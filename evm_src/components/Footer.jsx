...
export function Footer() {
  return (
    <footer style={{background:"var(--bgc)",borderTop:"1px solid var(--bdr)",padding:"48px 40px 28px",position:"relative",zIndex:1,overflow:"hidden"}}>
      ...
      <div style={{maxWidth:"1260px",margin:"0 auto"}}>
        <div className="footer-grid">
          ...
          <div>
            <div style={{display:"flex",alignItems:"center",gap:"10px",marginBottom:"14px"}}>
              ...
              <div>
                ...
                <div style={{fontSize:".56rem",fontWeight:700,letterSpacing:".2em",textTransform:"uppercase",color:"var(--sf)"}}>e-Ballot 2025</div>
              </div>
            </div>
            <p style={{fontSize:".8rem",color:"var(--t3)",lineHeight:1.85,maxWidth:"320px"}}>
              A fully digital mock election for the Student Council President at Vidyalankar Institute of Technology &amp; Management, Mumbai.
            </p>
          ...
          <div>
            ...
            <ul style={{listStyle:"none",display:"flex",flexDirection:"column",gap:"10px"}}>
              {["Student Council 2025","Date: 23 Feb 2025","09:00 AM – 05:00 PM","Main Campus, Mumbai","EC Office: Room B-204"].map(t=>(
        ...
        <div style={{paddingTop:"22px",borderTop:"1px solid var(--bdr)",display:"flex",alignItems:"center",justifyContent:"space-between",flexWrap:"wrap",gap:"12px",fontSize:".68rem",color:"var(--t3)"}}>
          <span>© 2025 Vidyalankar Institute of Technology &amp; Management. All rights reserved.</span>
